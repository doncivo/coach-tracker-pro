...
const EXERCISE_LIBRARY = [
  ...
  /* ═══════════════════════════════════════
     JAMBES (35 exercices)
  ═══════════════════════════════════════ */
  {name:'Squat barre (arrière)',muscle:'jam',pattern:'squat',equipment:'barre',difficulty:'intermédiaire',muscles_secondary:['bas'],tips:'Barre sur les trapèzes. Descendre jusqu\'à ce que les cuisses soient parallèles au sol minimum.',alternatives:['Squat goblet','Leg press','Squat front'],std_ratio:{bw60:1.0,bw75:1.4,bw90:1.8}},
  {name:'Squat avant (front squat)',muscle:'jam',pattern:'squat',equipment:'barre',difficulty:'avancé',muscles_secondary:['bas','ep'],tips:'Barre sur les clavicules. Plus vertical = plus de quadriceps. Mobilité de cheville requise.',alternatives:['Squat barre','Hack squat machine','Goblet squat'],std_ratio:{bw60:0.75,bw75:1.05,bw90:1.35}},
  {name:'Hack squat machine',muscle:'jam',pattern:'squat',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Pieds hauts sur la plateforme = plus de fessiers. Pieds bas = plus de quadriceps.',alternatives:['Squat barre','Leg press','Presse à cuisses'],std_ratio:{bw60:1.0,bw75:1.4,bw90:1.8}},
  {name:'Presse à cuisses',muscle:'jam',pattern:'squat',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Pieds à la largeur des épaules. Ne pas verrouiller les genoux en haut.',alternatives:['Squat barre','Hack squat machine','Leg press'],std_ratio:{bw60:1.2,bw75:1.7,bw90:2.2}},
  {name:'Leg press',muscle:'jam',pattern:'squat',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Pieds haut pour les fessiers, bas pour les quadriceps. Amplitude maximale sans arrondir le bas du dos.',alternatives:['Presse à cuisses','Hack squat machine'],std_ratio:{bw60:1.2,bw75:1.7,bw90:2.2}},
  {name:'Goblet squat',muscle:'jam',pattern:'squat',equipment:'haltères',difficulty:'débutant',muscles_secondary:['bas'],tips:'Haltère contre la poitrine. Excellent pour apprendre la technique du squat. Dos droit.',alternatives:['Squat barre','Leg press','Squat kettlebell'],std_ratio:{bw60:0.35,bw75:0.5,bw90:0.65}},
  {name:'Bulgarian split squat',muscle:'jam',pattern:'lunge',equipment:'haltères',difficulty:'intermédiaire',muscles_secondary:['bas'],tips:'Pied arrière sur banc. Descendre le genou arrière vers le sol. Excellent pour les fessiers.',alternatives:['Fentes','Hip thrust','Romanian deadlift'],std_ratio:{bw60:0.25,bw75:0.35,bw90:0.48}},
  {name:'Fentes marchées',muscle:'jam',pattern:'lunge',equipment:'haltères',difficulty:'débutant',muscles_secondary:['bas'],tips:'Enjamber en avant, genou arrière près du sol. Alterner les jambes.',alternatives:['Bulgarian split squat','Fentes statiques'],std_ratio:{bw60:0.2,bw75:0.28,bw90:0.38}},
  {name:'Fentes statiques',muscle:'jam',pattern:'lunge',equipment:'haltères',difficulty:'débutant',muscles_secondary:['bas'],tips:'Position de départ fendu. Descendre et monter sur place. Plus stable que les fentes marchées.',alternatives:['Fentes marchées','Bulgarian split squat'],std_ratio:{bw60:0.2,bw75:0.28,bw90:0.38}},
  {name:'Fentes barre',muscle:'jam',pattern:'lunge',equipment:'barre',difficulty:'intermédiaire',muscles_secondary:['bas'],tips:'Barre sur les épaules. Même technique que les fentes haltères mais plus lourdes.',alternatives:['Fentes marchées','Bulgarian split squat'],std_ratio:{bw60:0.6,bw75:0.85,bw90:1.1}},
  {name:'Hip thrust barre',muscle:'jam',pattern:'hinge',equipment:'barre',difficulty:'intermédiaire',muscles_secondary:[],tips:'Épaules sur banc, barre sur les hanches. Extension complète des hanches en haut.',alternatives:['Hip thrust machine','Glute bridge','Kickback câble'],std_ratio:{bw60:0.85,bw75:1.2,bw90:1.55}},
  {name:'Hip thrust machine',muscle:'jam',pattern:'hinge',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Régler selon la morphologie. Contraction maximale des fessiers en extension.',alternatives:['Hip thrust barre','Glute bridge','Leg press'],std_ratio:{bw60:0.85,bw75:1.2,bw90:1.55}},
  {name:'Glute bridge',muscle:'jam',pattern:'hinge',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Allongé, pieds à plat. Soulever les hanches. Version débutant du hip thrust.',alternatives:['Hip thrust barre','Hip thrust machine'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'SDT roumain haltères',muscle:'jam',pattern:'hinge',equipment:'haltères',difficulty:'débutant',muscles_secondary:['bas'],tips:'Dos droit, plier aux hanches. Descendre les haltères le long des jambes. Étirement des ischio.',alternatives:['SDT roumain barre','Nordic curl','Leg curl'],std_ratio:{bw60:0.3,bw75:0.42,bw90:0.55}},
  {name:'SDT roumain barre',muscle:'jam',pattern:'hinge',equipment:'barre',difficulty:'intermédiaire',muscles_secondary:['bas'],tips:'Même que haltères mais plus de charge possible. Barre proche du corps.',alternatives:['SDT roumain haltères','Good morning'],std_ratio:{bw60:0.75,bw75:1.05,bw90:1.35}},
  {name:'Soulevé de terre conventionnel',muscle:'jam',pattern:'hinge',equipment:'barre',difficulty:'intermédiaire',muscles_secondary:['dos','bas'],tips:'Prise en crochet ou pronation. Barre sur les tibias. Dos droit. Pousser le sol sous les pieds.',alternatives:['Trap bar deadlift','SDT roumain barre','Deadlift sumo'],std_ratio:{bw60:1.0,bw75:1.5,bw90:2.0}},
  {name:'Leg curl couché',muscle:'jam',pattern:'curl',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Isolation des ischio-jambiers. Amplitude complète. Pause en haut.',alternatives:['Leg curl assis','Nordic curl','SDT roumain'],std_ratio:{bw60:0.35,bw75:0.48,bw90:0.62}},
  {name:'Leg curl assis',muscle:'jam',pattern:'curl',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Position assise = plus d\'activation du biceps fémoral. Amplitude maximale.',alternatives:['Leg curl couché','Nordic curl'],std_ratio:{bw60:0.35,bw75:0.48,bw90:0.62}},
  {name:'Nordic curl',muscle:'jam',pattern:'curl',equipment:'poids du corps',difficulty:'avancé',muscles_secondary:[],tips:'Genou au sol, partenaire ou machine. Descendre lentement en contrôlant. Très intense.',alternatives:['Leg curl couché','SDT roumain'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Leg extension',muscle:'jam',pattern:'autre',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Isolation des quadriceps. Ne pas bloquer les genoux en haut. Contrôler la descente.',alternatives:['Presse à cuisses','Hack squat','Squat barre'],std_ratio:{bw60:0.4,bw75:0.55,bw90:0.72}},
  {name:'Mollets assis (machine)',muscle:'jam',pattern:'calf',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Cible le soléaire. Amplitude maximale. Pause en bas pour l\'étirement.',alternatives:['Mollets debout','Mollets à la presse'],std_ratio:{bw60:0.5,bw75:0.7,bw90:0.9}},
  {name:'Mollets debout',muscle:'jam',pattern:'calf',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Cible le gastrocnémien. Une jambe ou deux. Amplitude maximale.',alternatives:['Mollets assis','Mollets à la presse'],std_ratio:{bw60:0.75,bw75:1.0,bw90:1.35}},
  {name:'Mollets à la presse',muscle:'jam',pattern:'calf',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Pieds en bout de la plateforme. Extension complète des chevilles.',alternatives:['Mollets debout','Mollets assis'],std_ratio:{bw60:1.0,bw75:1.4,bw90:1.8}},
  {name:'Mollets haltères debout',muscle:'jam',pattern:'calf',equipment:'haltères',difficulty:'débutant',muscles_secondary:[],tips:'Un haltère dans chaque main ou un seul. Sur step pour plus d\'amplitude.',alternatives:['Mollets debout machine','Mollets assis'],std_ratio:{bw60:0.4,bw75:0.55,bw90:0.72}},
  {name:'Step-up',muscle:'jam',pattern:'lunge',equipment:'haltères',difficulty:'débutant',muscles_secondary:['bas'],tips:'Marche ou banc. Pousser avec le talon. Excellent pour les fessiers et quadriceps.',alternatives:['Fentes','Bulgarian split squat'],std_ratio:{bw60:0.2,bw75:0.28,bw90:0.38}},
  {name:'Box jump',muscle:'jam',pattern:'squat',equipment:'poids du corps',difficulty:'intermédiaire',muscles_secondary:[],tips:'Sauter sur une boîte. Atterrir silencieusement avec les genoux fléchis. Développe la puissance.',alternatives:['Squat sauté','Jump squat'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Squat sauté',muscle:'jam',pattern:'squat',equipment:'poids du corps',difficulty:'intermédiaire',muscles_secondary:[],tips:'Squat puis saut explosif. Atterrir en douceur. Excellent pour la puissance musculaire.',alternatives:['Box jump','Leg press'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Sumo squat',muscle:'jam',pattern:'squat',equipment:'haltères',difficulty:'débutant',muscles_secondary:[],tips:'Pieds très écartés, pointes en dehors. Haltère entre les jambes. Cible les adducteurs.',alternatives:['Plie squat','Goblet squat'],std_ratio:{bw60:0.35,bw75:0.5,bw90:0.65}},
  {name:'Pistol squat',muscle:'jam',pattern:'squat',equipment:'poids du corps',difficulty:'avancé',muscles_secondary:['bas'],tips:'Squat sur une jambe. Bras en avant pour contrebalancer. Progression: squat assisté.',alternatives:['Bulgarian split squat','Step-up'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Kickback fessier câble',muscle:'jam',pattern:'hinge',equipment:'câble',difficulty:'débutant',muscles_secondary:[],tips:'Poulie basse, cheville attachée. Extension de la hanche. Isolation des fessiers.',alternatives:['Hip thrust','Glute bridge'],std_ratio:{bw60:0.15,bw75:0.22,bw90:0.3}},
  {name:'Abduction hanche machine',muscle:'jam',pattern:'autre',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Cible les abducteurs et le moyen fessier. Indispensable pour équilibre musculaire.',alternatives:['Monster walk bande élastique'],std_ratio:{bw60:0.3,bw75:0.42,bw90:0.55}},
  {name:'Adduction hanche machine',muscle:'jam',pattern:'autre',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Cible les adducteurs. Complémentaire à l\'abduction.',alternatives:['Sumo squat'],std_ratio:{bw60:0.35,bw75:0.48,bw90:0.62}},
  {name:'Single leg RDL',muscle:'jam',pattern:'hinge',equipment:'haltères',difficulty:'intermédiaire',muscles_secondary:['bas'],tips:'Soulevé de terre roumain sur une jambe. Excellent pour l\'équilibre et les ischio.',alternatives:['SDT roumain haltères','Nordic curl'],std_ratio:{bw60:0.15,bw75:0.22,bw90:0.3}},
  {name:'Leg press pied haut',muscle:'jam',pattern:'squat',equipment:'machine',difficulty:'débutant',muscles_secondary:[],tips:'Pieds hauts sur la plateforme = activation maximale des fessiers et ischio.',alternatives:['Hip thrust barre','Presse à cuisses standard'],std_ratio:{bw60:1.2,bw75:1.7,bw90:2.2}},
  {name:'Cable pull-through',muscle:'jam',pattern:'hinge',equipment:'câble',difficulty:'débutant',muscles_secondary:['bas'],tips:'Poulie basse entre les jambes. Extension des hanches. Excellent pour apprendre le mouvement de charnière.',alternatives:['Hip thrust','SDT roumain'],std_ratio:{bw60:0.35,bw75:0.5,bw90:0.65}},
  ...
  /* CARDIO */
  {name:'Course à pied',muscle:'car',pattern:'cardio',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Échauffement 5 min marche. Maintenir une allure conversationnelle pour l\'\1ndurance de base.',alternatives:['Vélo','Rameur','Elliptique'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Vélo stationnaire',muscle:'car',pattern:'cardio',equipment:'machine',difficulty:'débutant',muscles_secondary:['jam'],tips:'Selle à hauteur correcte: genou légèrement fléchi en bas. Régler la résistance selon l\'\1bjectif.',alternatives:['Course à pied','Assault bike','Rameur'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Rameur',muscle:'car',pattern:'cardio',equipment:'machine',difficulty:'intermédiaire',muscles_secondary:['dos','jam'],tips:'60% jambes, 20% tronc, 20% bras. Garder le dos droit. Excellent full-body cardio.',alternatives:['Vélo stationnaire','Ski erg'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Elliptique',muscle:'car',pattern:'cardio',equipment:'machine',difficulty:'débutant',muscles_secondary:['jam','ep'],tips:'Faible impact articulaire. Idéal en récupération ou pour les personnes avec douleurs aux genoux.',alternatives:['Vélo stationnaire','Course à pied'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Assault bike',muscle:'car',pattern:'cardio',equipment:'machine',difficulty:'intermédiaire',muscles_secondary:['ep','jam'],tips:'Intensité maximale possible. Idéal pour HIIT. Résistance augmente avec la vitesse.',alternatives:['Rameur','Ski erg'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Ski erg',muscle:'car',pattern:'cardio',equipment:'machine',difficulty:'intermédiaire',muscles_secondary:['dos','abd'],tips:'Tirer avec les bras vers les hanches. Excellent pour le cardio et le dos.',alternatives:['Rameur','Assault bike'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Corde à sauter',muscle:'car',pattern:'cardio',equipment:'autre',difficulty:'débutant',muscles_secondary:['jam','ep'],tips:'Rester sur les avant-pieds. Sauts de 2-3 cm. Excellent pour la coordination et le cardio.',alternatives:['Course à pied','Box jump'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Burpee',muscle:'car',pattern:'cardio',equipment:'poids du corps',difficulty:'intermédiaire',muscles_secondary:['pec','jam','abd'],tips:'Position pompe, saut, recommencer. Maintenir un rythme régulier. Exercice complet.',alternatives:['Mountain climber','Squat sauté'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Sprint intervalle',muscle:'car',pattern:'cardio',equipment:'poids du corps',difficulty:'intermédiaire',muscles_secondary:['jam'],tips:'10-30 sec sprint max, récup 60-90 sec. 6-10 répétitions. HIIT très efficace.',alternatives:['Assault bike HIIT','Vélo HIIT'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Marche rapide',muscle:'car',pattern:'cardio',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:['jam'],tips:'Allure élevée mais maintenue. Excellent pour la récupération active. LISS cardio.',alternatives:['Course à pied','Vélo'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Natation',muscle:'car',pattern:'cardio',equipment:'autre',difficulty:'intermédiaire',muscles_secondary:['dos','ep','pec'],tips:'Faible impact articulaire. Excellent pour la récupération. Plusieurs nages possibles.',alternatives:['Rameur','Elliptique'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Corde ondulatoire (battle rope)',muscle:'car',pattern:'cardio',equipment:'autre',difficulty:'intermédiaire',muscles_secondary:['ep','abd'],tips:'Vagues alternées ou simultanées. 20-40 sec d\'\1ffort, 20-40 sec de repos.',alternatives:['Assault bike','Rameur'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Stepping (stepper)',muscle:'car',pattern:'cardio',equipment:'machine',difficulty:'débutant',muscles_secondary:['jam'],tips:'Mouvement régulier. Garder le dos droit. Excellent pour les fessiers et la condition cardio.',alternatives:['Elliptique','Marche rapide'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'HIIT circuit',muscle:'car',pattern:'cardio',equipment:'poids du corps',difficulty:'avancé',muscles_secondary:['jam','pec','abd'],tips:'Enchaîner plusieurs exercices sans repos entre eux. 3-5 tours. Adapter les exercices au niveau.',alternatives:['Burpee','Sprint intervalle'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Vélo extérieur',muscle:'car',pattern:'cardio',equipment:'autre',difficulty:'débutant',muscles_secondary:['jam'],tips:'Varier le terrain: plat pour l\'\1ndurance, côtes pour l\'\1ntensité. Porter un casque.',alternatives:['Vélo stationnaire','Course à pied'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  /* MOBILITÉ */
  {name:'Étirement ischio-jambiers',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Jambe tendue, pencher le tronc en avant. Maintenir 30-60 sec. Ne pas forcer.',alternatives:['Étirement assis en V','Yoga strap'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Étirement quadriceps',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Debout ou allongé. Tenir la cheville, genou pointé vers le sol. 30-60 sec par jambe.',alternatives:['Fente étirement','Foam roller quad'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Étirement pectoraux au mur',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:['ep'],tips:'Bras contre le mur à 90°. Rotation du corps. Sentir l\'\1tirement du pectoral.',alternatives:['Étirement haltère couché','Band pull-apart'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Foam roller dos',muscle:'mob',pattern:'recovery',equipment:'autre',difficulty:'débutant',muscles_secondary:[],tips:'Rouler lentement sur les points douloureux. Maintenir la pression 30-60 sec.',alternatives:['Massage balle','Étirement dos'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Foam roller quadriceps',muscle:'mob',pattern:'recovery',equipment:'autre',difficulty:'débutant',muscles_secondary:[],tips:'Face au sol. Rouler du genou à la hanche. Pause sur les nœuds musculaires.',alternatives:['Massage balle','Étirement quadriceps'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Étirement piriforme (fesse)',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Position figure 4 allongé. Tirer doucement le genou vers l\'\1paule opposée.',alternatives:['Pigeon yoga','Étirement fessier assis'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Hip flexor stretch',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Fente basse, genou arrière au sol. Hanches vers l\'\1vant et le bas. 45-60 sec.',alternatives:['Étirement psoas','Lunge stretch'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Mobilisation thoracique',muscle:'mob',pattern:'mobility',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Sur foam roller transversalement. Soutenir la nuque, s\'\1uvrir vers l\'\1rrière.',alternatives:['Foam roller dos','Cat-cow'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Cat-cow',muscle:'mob',pattern:'mobility',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:['bas','abd'],tips:'À 4 pattes. Alterner dos rond et dos creux. 10-15 répétitions lentes. Excellent réveil.',alternatives:['Mobilisation thoracique','Bird dog'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'World greatest stretch',muscle:'mob',pattern:'mobility',equipment:'poids du corps',difficulty:'intermédiaire',muscles_secondary:['jam','ep','bas'],tips:'Enchaîner fente, rotation de tronc, étirement ischio. Exercice de mobilité complet.',alternatives:['Hip flexor stretch','Étirement dynamique'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Band pull-apart',muscle:'mob',pattern:'mobility',equipment:'autre',difficulty:'débutant',muscles_secondary:['ep','dos'],tips:'Élastique à hauteur des épaules. Écarter les bras en gardant les coudes tendus. Santé épaule.',alternatives:['Face pulls','Y-raise incliné'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Étirement mollets',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Pied contre un mur ou sur une marche. Talon vers le sol. Genou tendu puis fléchi.',alternatives:['Foam roller mollets','Mobilisation cheville'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Mobilisation cheville',muscle:'mob',pattern:'mobility',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Cercles de cheville, flexion/extension. Indispensable avant squat et deadlift.',alternatives:['Étirement mollets','Box ankle stretch'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Étirement épaules croisés',muscle:'mob',pattern:'stretch',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'Bras croisé devant la poitrine. Maintenir avec l\'\1utre bras. 30 sec par côté.',alternatives:['Étirement pectoraux','Rotation épaule'],std_ratio:{bw60:1,bw75:1,bw90:1}},
  {name:'Récupération active (marche)',muscle:'mob',pattern:'recovery',equipment:'poids du corps',difficulty:'débutant',muscles_secondary:[],tips:'10-20 min de marche légère après une séance intensive. Accélère la récupération musculaire.',alternatives:['Vélo récup','Natation lente'],std_ratio:{bw60:1,bw75:1,bw90:1}},
